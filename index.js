		...
		items: [
			{
				...
				icon:
					'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-code preview-icon"><path d="m16 18 6-6-6-6"/><path d="m8 6-6 6 6 6"/></svg>',
			},
			{
			...
			},
			{
				...
				href:
					"https://samuelpetterssonps.github.io/Webbutveckling1/internet-ordbok",
				icon:
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				href:
					"https://github.com/samuelpetterssonps/Parkeringsautomaten",
				icon:
			...
			{
				title: "For-loopar",
				href: "https://github.com/samuelpetterssonps/FOR-loop",
				icon:
