const LINKS = [
	{
		...
		items: [
			...
			},
			{
				...
				icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg>'
			},
			{
				title: "GitHub",
				href: "https://github.com/samuelpetterssonps",
				icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-git-branch"><path d="M15 6a9 9 0 0 0-9 9V3"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/></svg>'
			},
		]
	},
	{
		title: "Webbutvecklingsprojekt",
		items: [
			{
				title: "Intro",
			...
			},
			{
				...
				href: "https://github.com/samuelpetterssonps/Webbutveckling1/tree/main/endiktomdagen"
			},
			{
				title: "Z-index",
				href: "https://github.com/samuelpetterssonps/Webbutveckling1/tree/main/z-index"
			}
		]
	}
];
