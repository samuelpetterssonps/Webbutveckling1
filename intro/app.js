...
const braSajterElement = document.querySelector("#bra-sajter");

for (const i of BRA_SAJTER) {
	const listItem = document.createElement("li");
	const anchor = document.createElement("a");
	listItem.appendChild(anchor);
	anchor.innerText = i.title;
	anchor.href = i.href;
	braSajterElement.appendChild(listItem)
}
